@extends('layouts.app')
@section('title', 'Shop Page - ' . config('app.name', 'E-Commerce'))
@section('content')
          ...
          <div class="shop-list flex-grow-1">
            ...
            <div class="products-grid row row-cols-2 row-cols-md-3" id="products-grid">
              ...
              <div class="product-card-wrapper">
               ...
               <div class="product-card card mb-3 mb-md-4 mb-xxl-5">
             
                <div class="pc__img-wrapper">
                  <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <a href="{{ route('single-product', ['id' => $product->id, 'slug' => $product->slug]) }}"><img loading="lazy" src="{{ $product->image }}" width=""
                            height="150" alt="{{ $product->name }}" class="pc__img"></a>
                      </div>
                      <div class="swiper-slide">
                        ...
                        @foreach ($galleryImages as $image)
                            ...
                            <a href="{{ route('single-product', ['id' => $product->id, 'slug' => $product->slug]) }}"><img loading="lazy" src="{{ asset('storage/' . $image) }}"
                                width="" height="" alt="Cropped Faux leather Jacket" class="pc__img"></a>
                        @endforeach
                    @else
                  ...
                  <a href="{{ route('cart.index') }}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart">Go To Cart</a>
                @else
              ...
              @endif
                ...
                <div class="pc__info position-relative">
                  ...
                  <h6 class="pc__title"><a href="details.html">{{ $product->name ?? 'N/A' }}</a></h6>
