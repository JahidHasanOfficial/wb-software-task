...
<body class="gradient-bg">
  ...
  <div class="header-mobile header_sticky">
    <div class="container d-flex align-items-center h-100">
      <a class="mobile-nav-activator d-block position-relative" href="#">
        ...
        <button class="top-0 btn-close-lg position-absolute start-0 w-100"></button>
      </a>
      ...
      <a href="#" class="header-tools__item header-tools__cart js-open-aside" data-aside="cartDrawer">
        ...
        <span class="cart-amount d-block position-absolute js-cart-items-count">32</span>
      </a>
    </div>
    ...
    <nav
      ...
      <div class="container">
        <form action="#" method="GET" class="mt-4 mb-3 search-field position-relative">
          <div class="position-relative">
            ...
            <button class="pb-0 btn-icon search-popup__submit me-2" type="submit">
              <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <use href="#icon_search" />
              </svg>
            </button>
            <button class="pb-0 btn-icon btn-close-lg search-popup__reset me-2" type="reset"></button>
          </div>
      ...
      <div class="pb-2 mt-auto border-top">
        <div class="container pb-1 mt-4 mb-2 customer-links">
          <svg class="align-middle d-inline-block" width="20" height="20" viewBox="0 0 20 20" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <use href="#icon_user" />
          </svg>
          <span class="align-middle d-inline-block ms-2 text-uppercase fw-medium">My Account</span>
        </div>



        <ul class="container flex-wrap mb-0 social-links list-unstyled d-flex">
          <li>
  ...
  <header id="header" class="header header-fullwidth header-transparent-bg">
    <div class="container">
      ...
      @else
          <div class="header-tools__item hover-container">
              <a href="{{ Auth::user()->user_type === 'user' ? route('user.index') : route('admin.index') }}" class="header-tools__item">
  ...
  <footer class="footer footer_type_2">
    ...
    <div class="footer-bottom">
      <div class="container d-md-flex align-items-center">
        <span class="footer-copyright me-auto">©2024 develop by jahid</span>
